...
public class StudentSubmissionListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "StudentSubmissionListAd";
    private List<SubmissionList> list;
    ...
    public StudentSubmissionListAdapter() {
        // uncomment the line below if you want to open only one row at a time
        // viewBinderHelper.setOpenOnlyOne(true);
    }

    public StudentSubmissionListAdapter(Fragment context, List<SubmissionList> list, RecyclerView recyclerView) {
        this.list = list;
    ...
    public StudentSubmissionListAdapter(Context context, List<SubmissionList> list, RecyclerView recyclerView) {
        this.list = list;
    ...
    public void updateList(List<SubmissionList> list) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        final SubmissionList object = list.get(position);
...
//                    } else {
                ...
                ((RowViewHolder) holder).accept.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        try {
                            update(object.getAssignemntSubLineId(), "accept");
                ...
                ((RowViewHolder) holder).reject.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        try {
                            update(object.getAssignemntSubLineId(), "reject");
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
                ...
                ((RowViewHolder) holder).change.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        try {
                            update(object.getAssignemntSubLineId(), "change");
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
                ...
                ((RowViewHolder) holder).cancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        try {
                            update(object.getAssignemntSubLineId(), "cancel");
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
...
//
        ...
        ((RowViewHolder) holder).sublay.setVisibility(View.VISIBLE);
...
//        ((RowViewHolder) holder).bind(position);
    ...
    private static class RowViewHolder extends RecyclerView.ViewHolder {
        private TextView name, assignmentname, submissiondate, state, description;
        ...
        public RowViewHolder(View itemView) {
            super(itemView);
            sublay = (LinearLayout) itemView.findViewById(R.id.sublay);
