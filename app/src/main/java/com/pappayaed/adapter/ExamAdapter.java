...
public class ExamAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<StuMarksheetLineDatum> list;
    private RecyclerAdapterPositionClicked recyclerAdapterPositionClicked;
    private Context context;

    public ExamAdapter(Fragment context, List<StuMarksheetLineDatum> list) {
        this.list = list;
    ...
    public ExamAdapter(Context context, List<StuMarksheetLineDatum> list) {
        this.list = list;
    ...
    public void updateList(List<StuMarksheetLineDatum> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        StuMarksheetLineDatum object = list.get(position);
