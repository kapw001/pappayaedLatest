...
public class StudentVideoRenderer extends RajawaliCardboardRenderer implements CardboardEventListener {


    private static final int NONE = 0;
    private static final int DRAG = 1;
    private static final int ZOOM = 2;
    private StudentActivity videoActivity;
    ...
    public StudentVideoRenderer(Activity activity) {
        super(activity.getApplicationContext());
        videoActivity = (StudentActivity) activity;
    }

    public StudentVideoRenderer(Activity activity, String videoPath) {
        super(activity.getApplicationContext());
