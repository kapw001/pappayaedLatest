...
import com.neointernet.neo360.activity.ListOFVideoActivity;
import com.neointernet.neo360.activity.StudentActivity;
...
public class TeacherVideoRenderer extends RajawaliCardboardRenderer implements CardboardEventListener {


    private static final int NONE = 0;
    private static final int DRAG = 1;
    private static final int ZOOM = 2;
    private ListOFVideoActivity videoActivity;
    ...
    public TeacherVideoRenderer(Activity activity) {
        super(activity.getApplicationContext());
        videoActivity = (ListOFVideoActivity) activity;
    }

    public TeacherVideoRenderer(Activity activity, String videoPath) {
        super(activity.getApplicationContext());
